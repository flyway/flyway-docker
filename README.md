...
-	[`5.0.2`, `5.0`, `5`, `latest` (*Dockerfile*)](https://github.com/boxfuse/flyway-docker/blob/master/Dockerfile)
-	[`5.0.2-alpine`, `5.0-alpine`, `5-alpine`, `latest-alpine` (*alpine/Dockerfile*)](https://github.com/boxfuse/flyway-docker/blob/master/alpine/Dockerfile)
-	[`4.2.0`, `4.2`, `4` (*Dockerfile*)](https://github.com/boxfuse/flyway-docker/blob/master/Dockerfile)
-	[`4.2.0-alpine`, `4.2-alpine`, `4-alpine` (*alpine/Dockerfile*)](https://github.com/boxfuse/flyway-docker/blob/master/alpine/Dockerfile)
